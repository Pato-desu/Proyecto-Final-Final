...
export var z1 = preload("res://Scenes/Enemies/Level One/1B.tscn")
export var z2 = preload("res://Scenes/Enemies/Level One/1C.tscn")
export var z3 = preload("res://Scenes/Enemies/Level One/Alfa1.tscn")
export var z4 = preload("res://Scenes/Enemies/Level One/Alfa2.tscn")
export var z5 = preload("res://Scenes/Enemies/Level One/2D.tscn")
